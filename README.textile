...
UPDATE: We should now support version 3 (work in progress)
...
* /usr/bin/openssl genrsa -aes128 -out private_key.pem -passout pass:_the_passphrase_ 2048
* /usr/bin/openssl req -x509 -new -key private_key.pem -passin pass:_the_passphrase_ -days 1825 -out private_certificate.cer
...
if Rails.env.production?
  Ideal::Gateway.environment = :live #default is :test
end
